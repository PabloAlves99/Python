...
if __name__ == "__main__":
    ...
    print(f'{cores["fechar"]}', f'{cores["verde"]}Essa é a nova lista dos produtos com um acrescimo de 10%:',
          *novos_produtos, sep='\n')

    print(f'{cores["fechar"]}', f'{cores["vermelho"]}Essa é a lista ordenada pelo nome:',
          *produtos_ordenados_por_nome, sep='\n')

    print(f'{cores["fechar"]}', f'{cores["amarelo"]}Essa é a lista ordenada pelo preço:',
